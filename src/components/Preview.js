    ...
    return (
      <>
        ...
        <section>
          ...
          <div>{this.props.previewData.general.name}</div>
          <div>{this.props.previewData.general.email}</div>
          <div>{this.props.previewData.general.phone}</div>
        </section>
        <section>
        ...
        <section>
          ...
          <div>
            {this.props.previewData.experience.map((element) => {
              return (
                <div>
